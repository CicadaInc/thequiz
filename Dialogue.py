...
def create_dialogue16():
    ...
    return [(font.render("И, кстати, игра", 1, (0, 0, 0)), (10, 0)),
            ...
            (font.render("", 1, (0, 0, 0)), (10, 120))]


def create_dialogue17():
    font = pygame.font.Font('fonts/comic.ttf', 16)
...
def create_dialogue18(number):
    font = pygame.font.Font('fonts/comic.ttf', 16)

    return [(font.render("Поздравляем!", 1, (0, 0, 0)), (10, 0)),
            (font.render("найдена пасхалка", 1, (0, 0, 0)), (10, 15)),
            (font.render("осталось ещё " + str(number), 1, (0, 0, 0)), (10, 30)),
            (font.render("", 1, (0, 0, 0)), (10, 45)),
            (font.render("", 1, (0, 0, 0)), (10, 60)),
...
def create_dialogue21():
    ...
    return [(font.render("Еммн...", 1, (0, 0, 0)), (10, 0)),
            ...
            (font.render("где тут блюдце летающее упало?", 1, (0, 0, 0)), (10, 45)),
            (font.render("Вроде мелькнула на востоке.", 1, (0, 0, 0)), (10, 60)),
            (font.render("Отыщи её и принеси мне", 1, (0, 0, 0)), (10, 75)),
            (font.render("код ошибки. Но знай, он", 1, (0, 0, 0)), (10, 90)),
            (font.render("зашифрован.", 1, (0, 0, 0)), (10, 105)),
            (font.render(" ", 1, (0, 0, 0)), (10, 120))]
