...
def create_dialogue01():
    ...
    return [(font.render("Приветсвую тебя, странник.", 1, (0, 0, 0)), (10, 10)),
            (font.render("Меня зовут проводником", 1, (0, 0, 0)), (10, 25)),
            (font.render("и я знаю все,", 1, (0, 0, 0)),
             (10, 40)),
            (font.render("что происходит в округе.", 1, (0, 0, 0)),
             (10, 55)),
            (font.render("И как ты понимаешь,", 1, (0, 0, 0)),
             (10, 70)),
            (font.render("если тебе нужна информация", 1, (0, 0, 0)),
             (10, 85)),
            (font.render(",за неё стоит платить", 1, (0, 0, 0)),
             (10, 100)),
            ]
